...
void ui_event_startbutton(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        _ui_state_modify(ui_startbutton, LV_STATE_CHECKED, _UI_MODIFY_STATE_REMOVE);
        etat = 1;
        printk("Button start");
    }
}
void ui_event_razbutton(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        _ui_state_modify(ui_razbutton, LV_STATE_CHECKED, _UI_MODIFY_STATE_REMOVE);
        update_display_chrono(0, 0);
        printk("Button raz");
        etat = 0;
    }
}
